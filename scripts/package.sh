#!/usr/bin/env bash
# Build google.zip (manifest.json at ROOT — required by install_plugin_from_zip)
...
FILE_URL="https://github.com/outcast1000/viboplr-google/releases/latest/download/google.zip"
...
rm -f google.zip
zip -q google.zip manifest.json index.js
...
echo
echo "To publish:"
echo "  gh release create v${VERSION} google.zip update.json --repo outcast1000/viboplr-google --title \"v${VERSION}\" --notes-file CHANGELOG.md"
